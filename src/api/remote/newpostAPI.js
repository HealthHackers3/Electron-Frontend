...
//     },
// ];
//newPost(postData).then(response => console.log(response));
//createCompletePost(postData, imageDataArray).then(r => console.log(r));
//checkPostName("Another cell posted").then(r => console.log(JSON.stringify(r)));